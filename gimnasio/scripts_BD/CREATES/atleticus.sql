...
--
-- Servidor: localhost
-- Tiempo de generación: 13-06-2015 a las 16:52:37
...
ALTER TABLE `detalle-ventas`
  ADD PRIMARY KEY (`id_detalle`), ADD KEY `id_venta` (`id_venta`), ADD KEY `id_producto` (`id_producto`);
...
--
ALTER TABLE `stocks`
  MODIFY `id_stock` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=30;
--
-- AUTO_INCREMENT de la tabla `talles`
--
ALTER TABLE `talles`
  MODIFY `id_talle` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=31;
--
